...
const LEGACY_EXAMPLE = readFileSync(
  path("website", "vendor", "pegjs", "arithmetics.pegjs"),
  "utf8"
)
...
app.post(
  "/online/download",
  bodyParser.urlencoded({ extended: false, limit: "1024kb" }),
  (req, res) => {
...
app.listen(80, () => {
  console.log(
    "The PEG.js website is running on the localhost in %s mode...",
    app.get("env")
  )
})
