...
declare namespace peg {
  ...
  namespace ast {
     ...
     */
    type Object = Grammar | Initializer | Rule | Named | Expression
  ...
  namespace compiler {
    ...
    function compile(
      ast: Grammar,
      session: Session,
      options?: ICompilerOptions<"parser">
    ): GeneratedParser
    ...
    function compile(
      ast: Grammar,
      session: Session,
      options?: ICompilerOptions<"source">
    ): string
  }
  ...
  interface IStageMap {
    [stage: string]: compiler.ICompilerPass[] | { [pass: string]: compiler.ICompilerPass }
  }
  ...
  interface IBuildOptions<T = compiler.OutputOptions>
